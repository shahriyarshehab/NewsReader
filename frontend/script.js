document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderNewspaperMenu() {
        ...
        console.log('Feeds to display for current category:', currentCategory, feedsToDisplay);
    ...
    async function fetchNews() {
        ...
        console.log('Feeds to fetch for current category:', currentCategory, feedsToFetch);
