document.addEventListener('DOMContentLoaded', () => {
            ...
            const newspaperMenu = document.getElementById('newspaper-menu'); // New element
            ...
            let currentNewspaper = null; // New state variable for selected newspaper
                ...
                if (allNewsItems.length > 0) {
                    ...
                    allNewsItems.forEach(item => {
                        ...
                        const link = document.createElement('a');
                                ...
                                link.href = item.link; // Directly link to the article
                        ...
                        pubDateDiv.appendChild(pubDate);
                        contentWrapper.appendChild(pubDateDiv);
                        ...
                        readMoreButton.textContent = 'Read Full Article'; // Changed text
                        readMoreDiv.appendChild(readMoreButton);
                        contentWrapper.appendChild(readMoreDiv);
            ...
            // Initial load
            renderNewspaperMenu(); // Render initial newspaper menu
            fetchNews();
        });